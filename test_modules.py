...
class TestModuleCreation:
    ...
    def test_import_module_unpermitted_attributes(self):
        module_dict = {"_type_": "Fitness",
                       "_subtype": "Power_5", "_permitted": "everything!"}
    ...
    def test_import_module_badtype_for_spread(self):
        module_dict = {"_type_": "Fitness",
                       "_subtype": "Power_5", "spread": "idunno"}
        default_module = createModule()
    ...
    def test_export_module(self):
        expected_dict = {'coeff': -19, 'spread': 10,
                         '_type_': 'Fitness', '_subtype': 'Power_3'}
...
class TestPowerSubtype:
    ...
    def test_get_response(self):
        defined_dict = {'coeff': -19, 'spread': 10,
                        '_type_': 'Fitness', '_subtype': 'Power_3'}
        ...
        with pytest.raises(TypeError):
            recieved_badtype_variable = defined_power_module.getResponse(
                badtype_variable)
...
class TestSineSubtype:
    ...
    def test_getResponse(self):
        defined_dict = {'coeff': -19, 'spread': 10,
                        '_type_': 'Fitness', '_subtype': 'Sine_3'}
...
class TestCosineSubtype:
    ...
    def test_get_response(self):
        defined_dict = {'coeff': -19, 'spread': 10,
                        '_type_': 'Fitness', '_subtype': 'Cosine_1'}
    ...
    def test_mutate(self):
        ...
        defined_dict = {'coeff': -19, 'spread': 10,
                        '_type_': 'Fitness', '_subtype': 'Cosine_1'}
        cosine_module = importModule(defined_dict)
        cosine_module.mutate()
        mutated = cosine_module.coeff
        assert round(mutated) == -9
