...
class TestSolverPropertyManagement:
    ...
    def test_set_fitness_calculator(self):
        ...
        assert isinstance(set_fitness_calculator_test_solver._fitness_calculator, LinearFitness)
        set_fitness_calculator_test_solver.fitness_calculator = "Dynamic"
        assert isinstance(set_fitness_calculator_test_solver._fitness_calculator, DynamicFitness)
...
#    def test_mutate_property(self): #TODO: Collect with other random number based tests that have inherent chance to fail.
#        mutate_property_solver = createSolver()
#        mutate_property_solver.property_mutation_chance = 100
#        original_properties = [mutate_property_solver.spread, mutate_property_solver.total_modules, mutate_property_solver.module_mutation_chance, mutate_property_solver.property_mutation_chance]
#        mutate_property_solver.mutate()
#        new_properties = [mutate_property_solver.spread, mutate_property_solver.total_modules, mutate_property_solver.module_mutation_chance, mutate_property_solver.property_mutation_chance]
#        assert new_properties != original_properties
    ...
    def test_export_solver(self):
        ...
        expected_dict = {'fitness_calculator': 'LinearFitness', '_children': 0, 'module_mutation_chance': 50, '_type_': 'Small', 'property_mutation_chance': 10, 'merge_module_chance': 50, 'spread': 10, 'total_modules': 5, '_modules': [], '_age': 0, 'unique': False, 'resilience': 2, 'swap_module_chance': 15, 'name': 'Tester'}
